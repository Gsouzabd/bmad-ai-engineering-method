        ...
        <div className="p-6 overflow-y-auto max-h-[60vh]">
          {activeTab === 'config' && (
            <div className="space-y-6">
                 ...
                 <div className="space-y-6">
                   {/* Mostrar credenciais configuradas mas token expirado */}
                   <div className="bg-orange-50 p-4 rounded-md">
                     ...
                     <div className="space-y-2 text-sm">
                       ...
                       <div className="flex items-center justify-between">
                         <span className="text-orange-800 font-medium">Client Secret:</span>
                         <span className="text-orange-700 font-mono text-xs bg-orange-100 px-2 py-1 rounded">
                           ••••••••••••••••••••
                         </span>
                       </div>
                       <div className="flex items-center justify-between">
                         <span className="text-orange-800 font-medium">Access Token:</span>
                         <span className="text-orange-700 font-mono text-xs bg-orange-100 px-2 py-1 rounded">
                           Expirado
                         </span>
                       </div>
                       <div className="flex items-center justify-between">
                         <span className="text-orange-800 font-medium">Refresh Token:</span>
                         <span className="text-orange-700 font-mono text-xs bg-orange-100 px-2 py-1 rounded">
                           ••••••••••••••••••••
                         </span>
                       </div>
                   ...
                   <div className="text-center">
                     <div className="mb-4">
                       <RefreshCw className="h-12 w-12 mx-auto text-orange-500 mb-2" />
                       <h4 className="text-lg font-medium text-black-main mb-2">
                         Renovar Token de Acesso
                       </h4>
                       <p className="text-gray-600 mb-6">
                         Seu token de acesso expirou. Clique no botão abaixo para renová-lo automaticamente.
                       </p>
                     </div>
                     <button
                   ...
                   <div className="border-t pt-4">
                     <div className="flex gap-2">
                       <button
                         onClick={() => setActiveTab('status')}
                         className="flex-1 px-3 py-2 text-sm text-gray-600 hover:text-gray-800 hover:bg-gray-50 rounded transition-colors"
                       >
                 ...
                 <div className="space-y-6">
                   ...
                   <div className="bg-green-50 p-4 rounded-md">
                     ...
                     <div className="space-y-2 text-sm">
                       ...
                       <div className="flex items-center justify-between">
                         <span className="text-green-800 font-medium">Client Secret:</span>
                         <span className="text-green-700 font-mono text-xs bg-green-100 px-2 py-1 rounded">
                           ••••••••••••••••••••
                         </span>
                       </div>
                   ...
                   <div className="text-center">
                     <div className="mb-4">
                       <ExternalLink className="h-12 w-12 mx-auto text-blue-500 mb-2" />
                       <h4 className="text-lg font-medium text-black-main mb-2">
                         Autorizar Acesso Google
                       </h4>
                       <p className="text-gray-600 mb-6">
                         Suas credenciais estão configuradas. Agora clique no botão abaixo para autorizar o acesso ao {tool.name}.
                       </p>
                     </div>
                     <button
                 ...
                 <div className="space-y-6">
                   ...
                   <div className="bg-green-50 p-4 rounded-md">
                     ...
                     <div className="space-y-2 text-sm">
                       ...
                       <div className="flex items-center justify-between">
                         <span className="text-green-800 font-medium">Access Token:</span>
                         <span className="text-green-700 font-mono text-xs bg-green-100 px-2 py-1 rounded">
                           ••••••••••••••••••••
                         </span>
                       </div>
                       <div className="flex items-center justify-between">
                         <span className="text-green-800 font-medium">Refresh Token:</span>
                         <span className="text-green-700 font-mono text-xs bg-green-100 px-2 py-1 rounded">
                           ••••••••••••••••••••
                         </span>
                       </div>
                   ...
                   <div className="text-center">
                     ...
                     <p className="text-gray-600 mb-6">
                       O {tool.name} está configurado e pronto para uso. Seus agentes de IA podem agora usar comandos específicos para esta ferramenta.
                     </p>
                   </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="text-sm text-gray-600 space-y-2">
                    ...
                    {credentials.updated_at !== credentials.created_at && (
                      <p><strong>Atualizado em:</strong> {new Date(credentials.updated_at).toLocaleDateString('pt-BR')}</p>
                    )}
                  </div>
